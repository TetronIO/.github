...
[MIMSyncScheduler](https://github.com/TetronIO/MIMSyncScheduler) is an open-source task orchestration tool for Microsoft Identity Manager 2016. It provides intelligent scheduling of MIM run profiles, PowerShell scripts, and SQL commands through XML configuration.
